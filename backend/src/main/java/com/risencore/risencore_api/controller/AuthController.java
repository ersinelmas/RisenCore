...
public class AuthController {
    ...
    @Operation(
            ...
            description =
                    "Registers a new user with the provided details. The user will be created with the default role of USER.",
            responses = {
    ...
    @PostMapping("/login")
    public ResponseEntity<JwtAuthenticationResponseDTO> loginUser(
